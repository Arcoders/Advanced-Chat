...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__components_right_groups_edit_group_vue__ = __webpack_require__(59);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_vue_multiselect__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_vue_multiselect___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_17_vue_multiselect__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__store_store__ = __webpack_require__(53);
...
Vue.component('multi-select', __WEBPACK_IMPORTED_MODULE_17_vue_multiselect___default.a);
...
var router = new __WEBPACK_IMPORTED_MODULE_0_vue_router__["a" /* default */]({
    routes: [{ path: '/', component: __WEBPACK_IMPORTED_MODULE_6__components_right_welcome_vue___default.a }, {
        ...
        children: [{ path: 'my', component: __WEBPACK_IMPORTED_MODULE_14__components_right_groups_my_groups_vue___default.a }, { path: 'edit/:group_id/:group_name', component: __WEBPACK_IMPORTED_MODULE_16__components_right_groups_edit_group_vue___default.a, name: 'edit_group' }]
...
new Vue({
    el: '#app',
    router: router,
    store: __WEBPACK_IMPORTED_MODULE_18__store_store__["a" /* store */]
});
        ...
        [
          ...
          _c("div", { staticClass: "group_input" }, [
            _c("label", { staticClass: "upload_avatar" }, [
              !_vm.groupAvatar
                ? _c("button", { staticClass: "button_upload" }, [
                    _c("i", { staticClass: "material-icons" }, [
                      _vm._v("backup")
                    ])
                  ])
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__group_mixins__ = __webpack_require__(62);
//
//
//
//
        ...
        getGroup: function getGroup() {
            ...
            this.$http.get('/groups/group/' + this.group_id).then(function (res) {
                ...
                if (res.status === 200) {
                    ...
                    _this.groupName = res.data.group.name;
                    _this.groupAvatar = res.data.group.avatar;
                    _this.selectedUsers = res.data.group.users;
                    ...
                    if (res.data.friends.length > 0) {
                        ...
                        _this.listFriends = res.data.friends;
                    } else {
                        _this.$snotify.warning('Find friends to add them to the group', 'Alert');
                    }
                } else {
                    _this.back();
                }
